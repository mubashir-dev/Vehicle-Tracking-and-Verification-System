<?php
class SFeeModel extends CI_Model
{
	...
	function feeStudentPay($id,$formarray)
	{
		$this->db->where('student_id', $id);
		$this->db->update('fee', $formarray);
	...
	public function getAllFeeStudent()
	{
		$query = $this->db->select('fee.*,student.student_name,student.student_id,student.student_reg_no')
			->from('fee')
			->join('student', 'student.student_id=fee.student_id')
			->get();
		return $query->result_array();
	}
