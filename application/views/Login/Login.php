					...
					<div class="card-body p-0">
						...
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block bg-login-image">
								<img src="/assets/img/vv_logo.jpg" class="img-responsive image-fluid" width="500" height="400">
							</div>
							<div class="col-lg-6 mt-3 p-4">
								<div class="p-5">
									<div class="text-center">
									<hr>
										<h4 style="color:black;font-weight:bold;">VV TRACKING SYSTEM</h4><hr>
										<h1 class="h4 text-gray-900 mb-4">Welcome Back!</h1>
									</div>
									<form class="user" method="POST" action="<?php echo base_url().'index.php/AuthController/login'; ?>">
