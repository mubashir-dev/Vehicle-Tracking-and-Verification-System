	...
	<div class="row">
							...
							<tbody>
								...
								if (!empty($rows)) { ?>
									...
									<?php foreach ($rows as $row) { ?>
										<?php $data['row'] = $row; ?>
										<?php $this->load->view('Department/single_row', $data); ?>
									<?php }
								} else { ?>
		...
		<script>
			function showModal() {
				...
				$.ajax({
					url: '<?php echo base_url() . 'index.php/DeptController/showCreateForm'; ?>',
					method: 'POST',
					data: {},
					dataType: 'json',
				...
				$("body").on("submit", "#CreateDeptModel", function(e) {
					e.preventDefault();
					$.ajax({
						url: '<?php echo base_url() . 'index.php/DeptController/saveDepartmentModel'; ?>',
						method: 'POST',
						data: $("#CreateDeptModel").serializeArray(),
						dataType: 'json',
						success: function(response) {
							if (response['status'] == 0) {
								if (response['deptname'] != "") {
									$(".deptError").html(response['deptname']).addClass("invalid-feedback d-block");
			...
			function showUpdateForm(id) {
				...
				$.ajax({
					url: '<?php echo base_url() . 'index.php/DeptController/updateDepartmentForm/'; ?>' + id,
					method: 'POST',
					data: {},
					dataType: 'json',
					success: function(response) {
			...
			function updateStudent() {
				$.ajax({
					url: '<?php echo base_url() . 'index.php/DeptController/updateDepartment'; ?>',
					method: 'POST',
			...
			function deleteRecored(id) {
				...
				$("body").on('click', '#delete_button', function(e) {
					$.ajax({
						url: '<?php echo base_url() . 'index.php/DeptController/deleteDepartmentModel/'; ?>' + id,
						method: 'POST',
						data: {},
						dataType: 'json',
						success: function(response) {
