<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="card shadow mb-4">
					<div class="card-header card-header-primary bg-primary text-white">
						<div class="row">
							<div class="col-md-8">
								<h4 class="card-title ">Student Fee Information</h4>
								<p class="card-category"> Here is the list of Fee Details of student who are using bus service</p>
							</div>
								...
								<tbody>
									...
									if (!empty($rows)) { ?>
										...
										<?php foreach ($rows as $row) { ?>
											<?php $data['row'] = $row; ?>
											<?php $this->load->view('studentfee/single_row', $data); ?>
										<?php }
									} else { ?>
				...
				<div class="modal-dialog  modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalCenterTitle">Load Student Data</h5>
			...
			<script>
				...
				function payStudentFee(id)
				{
					// alert(id);
					$.ajax({
						url: '<?php echo base_url() . 'index.php/SFeeController/payStudentFee'; ?>',
						method: 'POST',
						data: {id:id},
						dataType: 'json',
						success: function(response) {
