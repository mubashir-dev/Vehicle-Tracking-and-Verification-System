...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2020 at 10:09 PM
...
INSERT INTO `alerts` (`alert_id`, `alert_text`, `date`) VALUES
(1, 'Alert no 1', '2020-07-14'),
(2, 'Alert 2', '2020-07-08');
...
INSERT INTO `bus_location` (`loc_id`, `bus_id`, `loc_alt`, `loc_lang`, `date`) VALUES
(1, 2, 234832847, 423482394, '2020-07-11 06:23:00'),
(2, 2, 412412414, 231231231, '2020-07-11 03:21:00');
...
INSERT INTO `bus_timings` (`timing_id`, `route_id`, `stop_name`, `timing`) VALUES
(1, 1, 'Murre_chowk', '07:19:00'),
(2, 2, 'Panain Chowk', '44:18:00');
...
(1, 'Junaid AHmed Abbasi', '44444444444', 'Abbottabad'),
...
INSERT INTO `faculty` (`faculty_id`, `faculty_no`, `pass`, `faculty_name`, `faculty_cnic`, `dept_id`, `bus_id`, `route_id`, `faculty_contact`, `faculty_address`, `fee_data_link`, `status`) VALUES
(1, 'EE-22-IT-UOH/2020', '12345', 'Sardar Mubashir Ali', '92348923849', 1, 2, 2, '92348239148', 'Abbottabad', 1, 0),
(2, 'EE-32-IT-UOH', '12345', 'Ayesha Reham', '92348923833', 1, 2, 1, '92348239148dd', 'Abbottabad', 1, 0),
(3, '2312-22EE', '12345', 'Mehmood Ahmed', 'SADASJDK', 1, 2, 2, '12345678901', 'Havelian Abbottabad', 1, 0),
(4, 'IT-22-UOH', '12345', 'Kashif Malik', 'SADASJDK', 1, 1, 2, '03112345600', 'Havelian Abbottabad', 1, 0),
(6, 'IT-22-UOH', '12345', 'Muhammad Junaid', 'SADASJDK', 3, 2, 2, '03112345600', 'Abbottabad', 1, 0),
(7, '13131-EE', '12345', 'Umair Hussain', 'SADASJDK99', 1, 2, 1, '00213123188', 'Abbottabad', 1, 0),
(8, 'IT-22-11-UOH', '12345', 'Touseeq Ahmed Shah', '898989898999999', 3, 1, 2, '21312312377', 'Haripur', 1, 0),
(9, 'AGR-00-UOH/2020', '12345', 'Dr Mohiz Ahmed', '1330232493533', 1, 2, 1, '00044432024', 'Abbottabad', 1, 0),
(10, 'IT-22-V-UOH/2020', '12345', 'Asma Riaz', '1330232493587', 1, 2, 1, '03334467890', 'Havelian', 1, 0),
(11, 'ISl-2233', '12345', 'Sayyeda Habiba', '3719319831938', 2, 2, 2, '03332345678', 'Telephone Industry of Pakistan Colony Haripur ', 0, 1);
...
(1, 12000, 1, '2020-03-17', 1),
(2, 12000, 8, '0000-00-00', 0),
(3, 12000, 10, '0000-00-00', 0),
(4, 12000, 20, '0000-00-00', 0),
(5, 12000, 21, '0000-00-00', 0),
...
INSERT INTO `student` (`student_id`, `student_reg_no`, `password`, `student_name`, `bus_id`, `course_id`, `semester_id`, `dept_id`, `student_contact`, `route_id`, `student_address`, `fee_data_link`) VALUES
(1, 'F12-011', '1234', 'Umair Hussain Khan', 2, 2, 8, 1, '04444444444444444', 2, 'Wah Cantt ', 1),
(8, 'F13-001', '1234', 'Malik Majid', 1, 1, 6, 2, '30493204902', 2, 'Wah Cantt', 1),
(10, 'F11-099', '1234', 'Mohsin Ahmed', 2, 3, 7, 1, '984192481914', 2, 'Khalabat TownShip Haripur', 1),
(20, 'F20-112', '1234', 'Omer Malik', 2, 5, 6, 3, '9429482934', 1, 'Abbottabad', 1),
(21, '', '1234', 'Habiba Khan', 2, 3, 8, 1, '92348239148', 2, 'Wah Cantt Punjab Pakistan', 1),
(23, '', '1234', 'Mujeeb Ch', 2, 3, 6, 1, '03333456789', 1, 'Abbottabad', 1),
(24, '', '1234', 'Ahmed Mohib', 2, 4, 5, 1, '03334467890', 1, 'Abbottaaabadsakdlaskdl;sakdsla', 1),
(25, '', '1234', 'Aftab Khan', 2, 4, 8, 1, '03334467890', 1, 'jkjkjkjjjjjjjjjjj', 1),
(26, '', '1234', 'Fahad Malik', 2, 3, 2, 1, '92348239148', 2, 'Abbottabad Nawansher ', 1),
(27, '', '1234', 'Abdullah Hussain Ali', 1, 2, 6, 1, '92348239148', 2, 'Abbottabad', 1),
(28, '', '1234', 'Shoaib Ahmed', 2, 4, 2, 1, '034345678990', 1, 'Abbottabad', 1),
(30, '', '1234', 'Mubashir', 2, 4, 8, 1, '03332345678', 1, 'Abbottabad', 1),
(31, '', '1234', 'Habib Jalib', 2, 3, 2, 1, '3332323', 2, 'Abbottabad', 1),
(32, 'F13-022', '1234', 'Abdullah Malik', 1, 1, 2, 2, '489328492384', 2, '1', 1),
(33, 'Amit Patel', '1234', 'Samit Patel', 2, 1, 2, 2, '03333456789', 2, '1', 1),
(34, 'F13-00', '1234', 'Muhammad Perviz', 1, 1, 2, 2, '03334467890', 2, '1', 1);
...
(14, 'JuniorWebDev2020', 'Sardar Mubashir Ali', 'Admin', '$2y$10$dqVFgAKBOFd.FjFACiFPouuIQ2vgXW7IPJCiPAkY7XWnAZ2vqT53y', 'mubashir@edu.com');
...
--
ALTER TABLE `bus_timings`
  ADD CONSTRAINT `bus_timings_ibfk_1` FOREIGN KEY (`route_id`) REFERENCES `route` (`route_id`);
